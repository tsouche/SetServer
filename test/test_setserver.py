...
from ..app.constants import setserver_routes, getPlayersColl, getGamesColl
from ..app.reference_test_data import refPlayers_Dict, refPlayers, refGames_Dict
...
class test_Setserver(unittest.TestCase):
    ...
    def test_getGameDetails(self):
        ...
        self.assertEqual(status, "ok")
        self.assertEqual(gameid_str, gameid_str_ref)
